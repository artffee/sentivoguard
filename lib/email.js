...
Sign in:  https://sentivoguard.vercel.app/login
Members:  https://sentivoguard.vercel.app/members
Download: https://sentivoguard.vercel.app/members/download
  ...
  const html = baseLayout(
    ...
    `<p>Your free account is active. Here's what you can do right now:</p>
     ...
     <p style="margin: 28px 0;">
       <a href="https://sentivoguard.vercel.app/members/download"
     ...
     <p style="font-size: 14px; color: #4a5568;">
       Want the full suite?
       <a href="https://sentivoguard.vercel.app/members" style="color: #2d6a4f;">Upgrade to Plus</a>
...
Activate online: https://sentivoguard.vercel.app/members
Download:        https://sentivoguard.vercel.app/members/download
...
— SentivoGuard`;
  ...
  const html = baseLayout(
    ...
    `<p>Paste this key into <strong>Settings → License key</strong> in the desktop app
     ...
     <p style="margin: 28px 0;">
       <a href="https://sentivoguard.vercel.app/members"
          style="background: #2d6a4f; color: white; padding: 12px 22px; text-decoration: none;
                 border-radius: 8px; font-weight: 600; display: inline-block;">
         Activate online
       </a>
